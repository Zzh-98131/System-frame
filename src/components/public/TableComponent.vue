        ...
        <template slot-scope="scope">
          <span v-for="(i, id) in item.datas" :key="id" class="component-span" :title="i.title||null">
            ...
            <span v-if="i.type==='tagData'">
              <el-tag v-if="scope.row[i.content]===0" class="zero">
                0
              </el-tag>
              <el-tag v-else :class="i.shape||'round'" effect="dark" :type="scope.row[i.tagType]||i.tagType||'success'">
...
>>> .el-table td:nth-last-child(-n+1) , >>> .el-table th:nth-last-child(-n+2) > .cell {
  border: none;
}

/* 以下是特殊样式处理,以传入数据中的tableData.noBorderCols来区分，以数字英文标识 */
>>> .el-table.no_border_cols_one td:nth-last-child(-n+1) , >>> .el-table.no_border_cols_one th:nth-last-child(-n+2) > .cell , /* 倒数1行 */
>>> .el-table.no_border_cols_two td:nth-last-child(-n+2) , >>> .el-table.no_border_cols_two th:nth-last-child(-n+3) > .cell , /* 倒数2行 */
>>> .el-table.no_border_cols_three td:nth-last-child(-n+3) , >>> .el-table.no_border_cols_three th:nth-last-child(-n+4) > .cell , /* 倒数3行 */
>>> .el-table.no_border_cols_four td:nth-last-child(-n+4) , >>> .el-table.no_border_cols_four th:nth-last-child(-n+5) > .cell , /* 倒数4行 */
>>> .el-table.no_border_cols_five td:nth-last-child(-n+5) , >>> .el-table.no_border_cols_five th:nth-last-child(-n+6) > .cell , /* 倒数5行 */
>>> .el-table.no_border_cols_six td:nth-last-child(-n+6) , >>> .el-table.no_border_cols_six th:nth-last-child(-n+7) > .cell , /* 倒数6行 */
>>> .el-table.no_border_cols_seven td:nth-last-child(-n+7) , >>> .el-table.no_border_cols_seven th:nth-last-child(-n+8) > .cell , /* 倒数7行 */
>>> .el-table.no_border_cols_eight td:nth-last-child(-n+8) , >>> .el-table.no_border_cols_eight th:nth-last-child(-n+9) > .cell , /* 倒数8行 */
>>> .el-table.no_border_cols_nine td:nth-last-child(-n+9) , >>> .el-table.no_border_cols_nine th:nth-last-child(-n+10) > .cell , /* 倒数9行 */
>>> .el-table.no_border_cols_ten td:nth-last-child(-n+10) , >>> .el-table.no_border_cols_ten th:nth-last-child(-n+11) > .cell , /* 倒数10行 */
